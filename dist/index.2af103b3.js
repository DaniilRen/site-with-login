class e{toHTML(){let e=document.querySelector(".login-hidden-box");e.innerHTML=`
	...
	`}deleteFromDOM(){let e=document.querySelector(".login-hidden-box");e.innerHTML=""}}!function(){model=new e;let o=document.querySelector(".btnLogin-popup");o.addEventListener("click",()=>{var e;model.toHTML(),function(e){let o=document.querySelector(".register-link");o.addEventListener("click",()=>{e.classList.add("active")})}(e=wrapper=document.querySelector(".wrapper")),function(e){let o=document.querySelector(".login-link");o.addEventListener("click",()=>{e.classList.remove("active")})}(e),function(e){let o=document.querySelector(".icon-close");o.addEventListener("click",()=>{e.classList.remove("active-popup"),setTimeout(model.deleteFromDOM,1e3)})}(e),function(){let e=document.querySelector(".login"),o=document.querySelector("#login-submit");o.addEventListener("click",()=>{loginInfo=JSON.stringify({email:e.querySelector(".email").value,password:e.querySelector(".password").value,remember:e.querySelector(".remember-me").checked}),localStorage.setItem("loginInfo",loginInfo),console.log(loginInfo)})}(),function(){let e=document.querySelector(".register"),o=document.querySelector("#register-submit");o.addEventListener("click",()=>{registerInfo=JSON.stringify({email:e.querySelector(".email").value,password:e.querySelector(".password").value,username:e.querySelector(".username").value,agreement:e.querySelector(".agreement").checked}),localStorage.setItem("registerInfo",registerInfo),console.log(registerInfo)})}(),setTimeout(()=>wrapper.classList.add("active-popup"),10)})}();