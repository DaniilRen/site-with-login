class e{toHTML(){let e=document.querySelector(".login-hidden-box");e.innerHTML=`
	...
	`}deleteFromDOM(){let e=document.querySelector(".login-hidden-box");e.innerHTML=""}}function i(e,i){e.classList.remove("active-popup"),setTimeout(i.deleteFromDOM,1e3)}async function o(e){let i=await fetch("./utils/form.php",{method:"POST",headers:{"Content-type":"application/json"},body:JSON.stringify(e)}),o=await i.json();console.log(o)}!function(){let t=new e,n=document.querySelector(".btnLogin-popup");n.addEventListener("click",()=>{t.toHTML();let e=document.querySelector(".wrapper");(function(e){let i=e.querySelector(".register-link");i.addEventListener("click",()=>{e.classList.add("active")})})(e),function(e){let i=e.querySelector(".login-link");i.addEventListener("click",()=>{e.classList.remove("active")})}(e),function(e,o){let t=e.querySelector(".icon-close");t.addEventListener("click",()=>{i(e,o)})}(e,t),function(e,t){let n=document.getElementById("login-form"),s=document.querySelector(".login");n.addEventListener("submit",n=>{n.preventDefault();let l={mail:s.querySelector(".email").value,password:s.querySelector(".password").value,remember:s.querySelector(".remember-me").checked.toString()};o(l),i(e,t)})}(e,t),function(e,t){let n=document.getElementById("reg-form"),s=document.querySelector(".register");n.addEventListener("submit",n=>{n.preventDefault();let l={name:s.querySelector(".username").value,mail:s.querySelector(".email").value,password:s.querySelector(".password").value,agreement:s.querySelector(".agreement").checked.toString()};o(l),i(e,t)})}(e,t),setTimeout(()=>e.classList.add("active-popup"),10)})}();